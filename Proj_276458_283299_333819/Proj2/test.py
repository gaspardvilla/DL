...
# reduce the number of rounds equla to 2.
nb_rounds = 10
...
#Average train_error (%) on number_of_rounds Sequential models with Tanh and MSE loss
print("Average train_error on", nb_rounds,"Tanh with Dropout and MSE Loss is",Train_error_Tanh_Dropout_MSE[0],'%')

#Average test_error (%) on number_of_rounds Sequential models with Tanh and MSE loss
